...
- [x]Create and name repository 'javascript-challenge'.
- [x]Push html file and static folder to repository.
- [x]Complete Level 1 UFO objective. :heavy_exclamation_mark:Required
